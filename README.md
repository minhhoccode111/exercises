...
- `append(value)` adds a new node containing value to the end to the list or to start if list is empty
...
- Implement Linked Lists with classes and factory functions
- `get`/`set` in classes
- private variables in factory functions with closures
