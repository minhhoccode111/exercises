...
on a new line! ""Wow!"", the masses cried";
            ...
            int i1 = 1,
                i2 = 2; // Shorthand for multiple declarations
        ...
        public static void IterateAndPrint<T>(T toPrint)
        ...
        public static void OtherInterestingFeatures()
        {
            ...
            int maxCount = 0,
                count; // ref params must have value
            ...
            student.Introduce = new Func<string, string>(
                (introduceTo) =>
                    string.Format("Hey {0}, this is {1}", student.FirstName, introduceTo)
            );
            ...
            var query = filter.OrderBy(b => b.Wheels).ThenBy(b => b.Name).Select(b => b.Name); // still no query run
    ...
    public class MagicServiceException : Exception
    {
        ...
        public MagicServiceException(string message, int code)
            : base(message)
        {
            Code = code;
        }
